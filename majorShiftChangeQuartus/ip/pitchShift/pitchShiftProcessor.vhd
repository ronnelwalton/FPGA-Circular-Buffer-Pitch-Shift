...
architecture pitchshiftprocessor_arch of pitchshiftprocessor is
	...
	-- delta1 - sfix24_En16 - default value = "010110101000001001111001" =~0.70710678118
	signal delta1 : std_logic_vector (23 downto 0) := "010110101000001001111001";
	-- delta2 - sfix24_En16 - default value = "101101010000010011110011" =~1.41421356237
	signal delta2 : std_logic_vector (23 downto 0) := "101101010000010011110011";
	...
	bus_write : process (clk , reset) is
		begin
			if reset = '1' then
				delta1 <= "010110101000001001111001";
				delta2 <= "101101010000010011110011";
				enable <= "1"; -- 1
