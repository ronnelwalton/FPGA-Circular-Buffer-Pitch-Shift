...
-- -------------------------------------------------------------
-- 
-- Module: DualPortRAM_generic1
-- Source Path: majorChangeShift/majorChangeShift/DualPortRAM_generic1
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DualPortRAM_generic1 IS
...
END DualPortRAM_generic1;


ARCHITECTURE rtl OF DualPortRAM_generic1 IS
...
BEGIN
  ...
  DualPortRAM_generic1_process: PROCESS (clk)
  BEGIN
    IF clk'event AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS DualPortRAM_generic1_process;
